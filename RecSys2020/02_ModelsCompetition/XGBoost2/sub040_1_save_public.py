...
FILE_NAME_test = "../preprocessings/test-0.parquet"
FILE_NAME_text = "../preprocessings/text-processings-1.parquet"
FILE_NAME_user = "../preprocessings/a_count_combined-final.parquet"

# output
FILE_NAME_X_train = f"data/X_train_{SUB_NAME}.pkl"
FILE_NAME_Y_train = f"data/Y_train_{SUB_NAME}.pkl"
FILE_NAME_X_test = f"data/X_test_{SUB_NAME}_pub.pkl"
...
if __name__ == "__main__":
    ...
    to_pkl_gzip(X_train, FILE_NAME_X_train)
    to_pkl_gzip(Y_train, FILE_NAME_Y_train)
